...
import logo from '../../../src/assets/trainer.png'
                    ...
                    <div className='authform'>
                        ...
                        <div className='right'>
                            ...
                            <form action="">
                                ...
                                <Input color="warning" size="lg" variant="soft" type="number" placeholder='Weight in kg'
                                    onChange={(e) => {
                                        setSignupFormData({
                                            ...signupformData,
                                ...
                                <Input color="warning" size="lg" variant="soft" type="number" placeholder='cm'
                                    onChange={(e) => {
                                        setSignupFormData({
                                            ...signupformData,
